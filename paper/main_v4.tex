...
\begin{abstract}
\noindent\textbf{Background.} Excluding infectious children from school is a comparatively well-studied influenza measure, but keeping infectious adults home from work (sick leave) is far less established, and the two have rarely been compared in one model. For an age-structured pathogen a single effect-size can mislead, because transmission removed from work or school is not eliminated but shifts into the household, some transmission occurs before symptoms and escapes symptom-triggered absence, and the effect varies by age and by the timing of the intervention within the season.

\noindent\textbf{Methods.} We built an age-structured deterministic SVEIR model of the Seoul Capital Area, with 15 age groups and four contact settings (home, work, school, and other), whose infectious period includes a distinct presymptomatic stage that transmits but is not yet subject to absence. It was calibrated by Bayesian inference to National Health Insurance Service (NHIS) claims for three ordinary seasons (2016--17, 2017--18, 2019--20), with the school calendar represented by a time-varying contact matrix and the intervention by added within-home transmission from symptomatic absentees. Sick leave and school absence were then compared at matched intensity by posterior forward simulation with credible intervals.

\noindent\textbf{Results.} School absence was more effective and more certain than sick leave. It averted 1.56 to 3.36\% of infections, with a credible reduction in every age band and season and roughly five times more than sick leave in absolute numbers (about 123{,}000 versus 23{,}000 in 2019--20), because school contacts are child-dominated and drive the epidemic despite being a small share of transmission. Sick leave's benefit was small (0.23 to 0.46\%) and indistinguishable from zero in two of three seasons. It redistributed infection rather than reducing it, as adult infection fell while school-age children's rose in all three seasons, and this shift toward children was larger during the winter break, when the household stays open while schools close.

\noindent\textbf{Conclusions.} For an age-structured pathogen with presymptomatic transmission, school-based measures are more effective and more certain than sick leave and carry no household-spillover risk. Sick leave's population benefit is small and not firmly established. Where it is used, it should be paired with household-isolation support, especially during school holidays when its shift of risk toward children is largest. Absenteeism policy should be judged by whom it moves risk toward and when it is applied, not by an aggregate effect size alone.
\end{abstract}
