...
OUT_FIG = REPO_ROOT / "presentations" / "figures" / "smoke_phifixed.png"
...
def run_target(label: str, r0contrib: np.ndarray, setup) -> dict:
    ...
    json_path = OUT_DIR / f"smoke_phifixed_{label}.json"
...
def main():
    ...
    all_results = []
    for label, tgt in [("T_B", T_B_R0CONTRIB), ("T_lit", T_LIT_R0CONTRIB)]:
        try:
