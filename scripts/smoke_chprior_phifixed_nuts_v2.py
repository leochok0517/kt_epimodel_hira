...
OUT_FIG = REPO_ROOT / "presentations" / "figures" / "smoke_phifixed_v2.png"
# v2: separate output paths so we don't overwrite v1 results
V2_JSON_PREFIX = "smoke_phifixed_v2"
